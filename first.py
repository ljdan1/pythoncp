...
#20 Method Overloading (Using Default Arguments Write a MathOperations class with a method add(), which should take either two or three numbers and return their sum. Use default parameters to achieve this.
